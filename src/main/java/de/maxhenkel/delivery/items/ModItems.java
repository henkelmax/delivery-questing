...
public class ModItems {
    ...
    public static final Item CARDBOARD = new Item(new Item.Properties().group(ModItemGroups.TAB_DELIVERY)).setRegistryName(Main.MODID, "cardboard");
    ...
    public static final Item UPGRADE_BASE = new Item(new Item.Properties().group(ModItemGroups.TAB_DELIVERY)).setRegistryName(Main.MODID, "upgrade_base");
